            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                <div className="h-56 w-full">
                    <a href="#">
                        ...
                        <img className="mx-auto hidden h-full" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front-dark.svg" alt="" />
                    </a>
                </div>
                <div className="pt-6">
                    <div className="mb-4 flex items-center justify-between gap-4">
                        <span className="me-2 rounded bg-blue-100 px-2.5 py-0.5 text-xs font-medium text-blue-800"> Up to 35% off </span>
                        <div className="flex items-center justify-end gap-1">
                            ...
                            <button type="button" data-tooltip-target="tooltip-add-to-favorites" className="rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900  dark:hover:bg-gray-700">
                    ...
                    <a href="#" className="text-lg font-semibold leading-tight text-gray-900 hover:underline">{product.product_name}</a>
                    ...
                    <div className="mt-2 flex items-center gap-2">
                        ...
                        <p className="text-sm font-medium text-gray-900">{product.stars}</p>
                    ...
                    <ul className="mt-2 flex items-center gap-4">
                        <li className="flex items-center gap-2">
                            ...
                            <p className="text-sm font-medium text-gray-500">{product.feature}</p>
                        </li>
                        <li className="flex items-center gap-2">
                            <svg className="h-4 w-4 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    ...
                    <div className="mt-4 flex items-center justify-between gap-4">
                        <p className="text-2xl font-extrabold leading-tight text-gray-900">${product.product_price}</p>
                        <button type="button" className="inline-flex shrink-0 items-center rounded-lg bg-blue-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4  focus:ring-blue-300">
